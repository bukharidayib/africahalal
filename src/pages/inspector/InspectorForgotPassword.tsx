...
export default function InspectorForgotPassword() {
          ...
          <div className="mb-10">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground uppercase tracking-widest">Inspector Account Recovery</p>
              </div>
            </div>
          ...
          {!isSubmitted ? (
            ...
            <div className="bg-primary/5 border border-primary/10 rounded-xl p-8 text-center space-y-4">
              ...
              <Button variant="outline" className="w-full mt-4 h-11 border-primary/20 hover:bg-primary/5 text-primary" asChild>
                <Link to="/inspector/signin">Return to Sign In</Link>
              </Button>
            </div>
          )}
        </div>
