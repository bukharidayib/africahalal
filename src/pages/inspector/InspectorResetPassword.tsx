...
export default function InspectorResetPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      else { setIsSuccess(true); setTimeout(() => navigate("/inspector/signin"), 3000); }
    ...
    <div className="flex min-h-screen bg-background">
      <div className="flex w-full flex-col justify-center px-4 py-12 sm:px-6 lg:w-1/2 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="mb-10">
            <Link to="/inspector/signin" className="inline-flex items-center text-sm text-muted-foreground hover:text-primary mb-8 transition-colors">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground uppercase tracking-widest">Inspector Password Reset</p>
              </div>
            </div>
            <h2 className="text-3xl font-bold tracking-tight text-foreground font-serif">Set New Password</h2>
            <p className="mt-2 text-sm text-muted-foreground">Choose a strong new password for your inspector account.</p>
          </div>
          ...
          {isSuccess ? (
            <div className="bg-primary/5 border border-primary/10 rounded-xl p-8 text-center space-y-4">
              ...
              <Button variant="outline" className="w-full mt-4 h-11" asChild>
                <Link to="/inspector/signin">Go to Sign In</Link>
              </Button>
            </div>
          ) : !isReady ? (
            <div className="text-center py-8 space-y-4">
              ...
              <Button variant="outline" asChild><Link to="/inspector/forgot-password">Request New Link</Link></Button>
            </div>
          ) : (
