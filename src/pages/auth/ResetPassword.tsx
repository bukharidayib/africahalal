                ...
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    <div className="mb-10">
                        ...
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-muted-foreground uppercase tracking-widest">Password Reset</p>
                            </div>
                        </div>
                    ...
                    {isSuccess ? (
                        ...
                        <div className="text-center py-8 space-y-4">
                            ...
                            <Button variant="outline" asChild><Link to="/auth/forgot-password">Request New Link</Link></Button>
                        </div>
                    ) : (
