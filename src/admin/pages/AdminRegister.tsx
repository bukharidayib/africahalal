    ...
    try {
      ...
      if (authData.user) {
        ...
        toast({
          ...
          description: "Please verify your email address, then sign in to the Admin Portal.",
        });
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex w-full flex-col justify-center px-4 py-12 sm:px-6 lg:w-1/2 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="mb-8">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-foreground font-serif">Create Your Admin Account</h2>
            <p className="mt-2 text-sm text-muted-foreground">Complete your profile to access the AHIS Admin Portal</p>
          </div>

          {/* Invitation Banner */}
          {email && (
            <div className="bg-primary/5 border border-primary/20 rounded-lg px-4 py-3 mb-6">
              <p className="text-xs text-primary font-medium">✉ Invited as Administrator</p>
          ...
          <p className="text-center text-sm text-muted-foreground pt-6">
            ...
            <Link to="/admin/login" className="font-semibold text-primary hover:text-primary/80 underline-offset-4 hover:underline">
      ...
      <div className="hidden lg:relative lg:block lg:w-1/2 border-l overflow-hidden">
        <img className="absolute inset-0 h-full w-full object-cover" src="/auth-bg.png" alt="AHIS Admin Portal" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-white">
          ...
          <h3 className="text-3xl font-bold font-serif leading-tight text-center mb-4">Admin Portal Access</h3>
          <p className="text-lg text-white/80 leading-relaxed text-center max-w-md">
            You've been invited to manage Halal certification operations for the Africa Halal Integrity System.
          </p>
          <div className="mt-8 flex flex-col gap-3 w-full max-w-xs">
            {["Review certification applications", "Manage inspections & reports", "Issue & revoke certificates", "Access audit logs"].map((item) => (
