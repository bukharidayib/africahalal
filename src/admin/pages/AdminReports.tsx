      ...
      try {
        ...
        const unified: UnifiedRow[] = [
          ...inspectorReports.map((r) => ({
            ...
            authorName: String(profileMap.get(r.inspector_id) || "Unknown"),
          ...
          ...supervisorReports.map((r) => ({
            ...
            kind: "report" as const,
            date: r.report_date || r.created_at,
            authorName: String(profileMap.get(r.supervisor_id) || "Unknown"),
          ...
          ...inspectorIncidents.map((r) => ({
            ...
            date: r.created_at,
            authorName: String(profileMap.get(r.reported_by) || "Unknown"),
